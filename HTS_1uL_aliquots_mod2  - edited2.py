...
def get_values(*names):
    ...
    _all_values = json.loads("""{"pipette_type":"p300_multi_gen2","tip_type":0,"trough_type":"nest_12_reservoir_15ml","plate_type":"corning3575_384well_alt","dilution_factor":2,"num_of_dilutions":11,"total_mixing_volume":20,"tip_use_strategy":"never"}""")
...
def run(protocol_context):
    ...
    #tip_name = 'opentrons_96_tiprack_20ul' # want 300uL tips to pick up 240uL to distribute
