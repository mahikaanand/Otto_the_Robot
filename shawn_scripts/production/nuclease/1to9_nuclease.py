...
def nuclease(protocol):
    ...
    #add buffer
    p300m.pick_up_tip()
    p300m.distribute(18, plate96.rows()[0][buff_col],
                     temp_pcr.rows()[0][1:7],
