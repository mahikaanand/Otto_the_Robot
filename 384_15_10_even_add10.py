...
def run(protocol_context):
    ...
    pipette.pick_up_tip()
    #loop to fill even rows of assay_plate
    assay_prep.fill_plate_with_buffer(evenodd=1, rangestart=1, rangeend=24)
    ...
    pipette.pick_up_tip()
    #loop to fill even rows of assay_plate
    assay_prep.fill_plate_with_reagent(evenodd=1, rangestart=0, rangeend=24)
    ...
    def serial_dilution(self, evenodd, rangestart, num_of_dilutions):
        ...
        for source, dest in zip(
            ...
            self.pipette.transfer(
                ...
                source,
                dest,
                mix_after=(3, total_mixing_volume/1.34),
                new_tip="never"
            )       
