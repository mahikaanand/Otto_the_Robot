...
def run(protocol_context):
    ...
    # labware
    compound_plates = protocol_context.load_labware("costar_96_wellplate_200ul", 1)
    ...
    pipette.pick_up_tip()
    compound_dilution.fill_plate_with_dmso(dmso=dmso_troughs, compound_plate=compound_plates, rangestart=1, rangeend=12)
    compound_dilution.serial_dilution(compound_plate=compound_plates, rangestart=0, num_of_dilutions=11)
    pipette.drop_tip()
