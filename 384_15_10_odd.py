...
def run(protocol_context):
    ...
    assay_prep = AssayPrep(assay_plate, pipette, buffer, enzyme, liquid_trash, transfer_volume)
...
class AssayPrep:
    def __init__(self, assay_plate, pipette, buffer, enzyme, liquid_trash, transfer_volume):
